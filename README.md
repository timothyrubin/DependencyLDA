...
You can try experimenting with increasing these values, which could potentially speed up the model in terms of time until convergence. But this has not been thoroughly tested.
